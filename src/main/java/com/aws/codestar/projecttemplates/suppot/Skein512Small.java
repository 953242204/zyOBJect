...
public class Skein512Small {
	...
	/**
	 * @param message 欲加密的字串
	 * @return 加密後的字串
	 * @throws java.io.IOException
	 */
	public static String hash(String message) throws java.io.IOException {
		return hash(message.getBytes(Charset.forName("UTF-8")), new byte[128]);
	}

	public static String hash(byte[] m, byte[] h) throws java.io.IOException {
		...
		return org.apache.commons.codec.binary.Hex.encodeHexString(h).replaceAll("[0]+$", "");
	}
