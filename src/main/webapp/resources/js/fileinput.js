...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            //noinspection HtmlUnknownAttribute
            tBtnBrowse = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>'+//redan
            	'<button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#tagFriend">標註朋友</button>'+
            	'<button type="button" id="post-story-button" class="btn btn-outline-primary">送出</button>';
